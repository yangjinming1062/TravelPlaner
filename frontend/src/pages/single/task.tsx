              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">充分挖掘单个目的地的精彩之处，避免走马观花</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">智能推荐目的地内部最值得游览的景点和活动</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">根据行程安排推荐最佳住宿位置，节省交通时间</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">合理分配各景点游览时间，确保旅程轻松愉快</p>
                  </div>
                </div>
              </CardContent>
            </Card>
