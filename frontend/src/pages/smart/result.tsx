  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        {/* 推荐理由 */}
        {planResult.recommendation_reasons && planResult.recommendation_reasons.length > 0 && (
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
        ...
        {/* 目的地亮点 */}
        {planResult.destination_highlights && planResult.destination_highlights.length > 0 && (
          <HighlightsList 
