...
class PlanningController:
    ...
    @staticmethod
    def plan_single_destination(params: PlanningSingleTask):
        """
        执行单一目的地规划
        """
        try:
    ...
    @staticmethod
    def plan_route(params: PlanningRouteTask):
        """
        执行沿途游玩规划
        """
        try:
    ...
    @staticmethod
    def plan_multi_node(params: PlanningMultiTask):
        """
        执行多节点规划
        """
        try:
    ...
    @staticmethod
    def plan_smart_recommendation(params: PlanningSmartTask):
        """
        执行智能推荐规划
        """
        try:
...
def add_planning_tasks(background_tasks: BackgroundTasks, item):
    """根据模型类型添加对应的后台规划任务"""
    task_map = {
        PlanningSingleTask: PlanningController.plan_single_destination,
        PlanningRouteTask: PlanningController.plan_route,
        PlanningMultiTask: PlanningController.plan_multi_node,
        PlanningSmartTask: PlanningController.plan_smart_recommendation,
    }
    if task := task_map.get(type(item)):
        background_tasks.add_task(task, item)
